...
int main(int argc , char *argv[])
{
    ...
    unsigned long long int  Xl_sums[Size];
    unsigned long long int  Xr_sums[Size];
    unsigned long long int  Yl_sums[Size];
    unsigned long long int  Yr_sums[Size];
    unsigned long long int  X_sums[Size];
    unsigned long long int  Y_sums[Size];
    unsigned long long int  final_sums[Size];
